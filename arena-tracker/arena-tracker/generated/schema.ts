...
export class ProtocolFeeInfoSet extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ProtocolFeeInfoSet entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ProtocolFeeInfoSet must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("ProtocolFeeInfoSet", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): ProtocolFeeInfoSet | null {
    return changetype<ProtocolFeeInfoSet | null>(
      store.get_in_block("ProtocolFeeInfoSet", id.toHexString()),
    );
  }

  static load(id: Bytes): ProtocolFeeInfoSet | null {
    return changetype<ProtocolFeeInfoSet | null>(
      store.get("ProtocolFeeInfoSet", id.toHexString()),
    );
  }
  ...
  get feeReceiverAddress(): Bytes {
    let value = this.get("feeReceiverAddress");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set feeReceiverAddress(value: Bytes) {
    this.set("feeReceiverAddress", Value.fromBytes(value));
  }

  get feePercentageInBps(): BigInt {
    let value = this.get("feePercentageInBps");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set feePercentageInBps(value: BigInt) {
    this.set("feePercentageInBps", Value.fromBigInt(value));
  }

  get previousFeePercentageInBps(): BigInt {
    let value = this.get("previousFeePercentageInBps");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set previousFeePercentageInBps(value: BigInt) {
    this.set("previousFeePercentageInBps", Value.fromBigInt(value));
  }
